...
public class GlobalData {//password fieldları yaddan çixib //idler sehv verirdi onuda duzeldek
    ...
    public static ClassesDynamicArray classesDynamicArray ;

    public static PersonDinamicArray personDinamicArray;//dinamic array obyektimizi yaratdiq static blockda admin elave edek
